...
const GalaxyCard = ({ title, link, summary }) => (
  <div className="sm:w-1/2 xl:w-1/3 flex flex-col justify-start p-4">
    <Link href={link} passHref>
      <a
        href={link}
        className="p-8 shadow-md bg-white dark:bg-transparent hover:shadow-lg dark:light-shadow-md rounded-2xl dark:hover:light-shadow-xl dark:border-gray-800 h-full cursor-pointer"
      >
        <div>
