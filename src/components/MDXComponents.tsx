...
const MDXComponents = {
  h1: (props) => (
    <h1 className="text-7xl text-gray-800 dark:text-gray-200 mt-12 mb-4">
      {props.children}
    </h1>
  ),
  h2: (props) => (
    <h2 className="text-6xl text-gray-800 dark:text-gray-200 font-medium mt-12 mb-4">
      {props.children}
    </h2>
  ),
  h3: (props) => (
    <h3 className="text-5xl text-gray-800 dark:text-gray-200 font-medium mt-12 mb-4">
      {props.children}
    </h3>
  ),
  h4: (props) => (
    <h4 className="text-4xl text-gray-800 dark:text-gray-200 mt-12 mb-4">
      {props.children}
    </h4>
  ),
  ...
  p: (props) => (
    <p className="text-2xl font-light text-gray-700 dark:text-gray-400 md:leading-normal">
      {props.children}
    </p>
  ),
  YoutubeVideo: ({ id }) => (
